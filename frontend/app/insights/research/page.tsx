...
const filters = ["All", "AI & Automation", "Growth", "Markets", "Operations"] as const;
...
const reports = [
  { cat: "AI & Automation", title: "AI for Business India", excerpt: "How Indian enterprises are deploying AI beyond pilots into measurable revenue.", meta: "Feb 2026 · 14 min", img: "https://images.unsplash.com/photo-1677442136019-21780ecad995?q=80&w=1200&auto=format&fit=crop", href: "/insights/ai-india" },
  { cat: "Growth", title: "Digital Marketing Trends", excerpt: "The channels, formats, and budgets defining performance marketing this year.", meta: "Feb 2026 · 11 min", img: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1200&auto=format&fit=crop", href: "/insights/marketing-trends" },
  { cat: "Markets", title: "The State of D2C Commerce", excerpt: "Unit economics, retention, and the path to profitability for digital-first brands.", meta: "Jan 2026 · 9 min", img: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?q=80&w=1200&auto=format&fit=crop", href: "/legal/contact-us" },
  { cat: "Operations", title: "Automation Maturity Index", excerpt: "Benchmarking how far enterprises have actually automated their core workflows.", meta: "Jan 2026 · 12 min", img: "https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=1200&auto=format&fit=crop", href: "/legal/contact-us" },
  { cat: "Growth", title: "GEO & the New Search Frontier", excerpt: "Why generative engines are the most important search shift in a decade.", meta: "Dec 2025 · 10 min", img: "https://images.unsplash.com/photo-1633356122544-f134324a6cee?q=80&w=1200&auto=format&fit=crop", href: "/legal/contact-us" },
  { cat: "Markets", title: "Capital & Climate 2026", excerpt: "Where sustainability-linked capital is flowing and what it expects in return.", meta: "Dec 2025 · 13 min", img: "https://images.unsplash.com/photo-1497436072909-60f360e1d4b1?q=80&w=1200&auto=format&fit=crop", href: "/industries/climate-tech" },
];
...
export default function Page() {
  ...
  const filteredReports =
    activeFilter === "All"
      ? reports
      : reports.filter((r) => r.cat === activeFilter);
      ...
      <section className="mx-auto w-full max-w-[1220px] px-5 sm:px-6 lg:px-8 pb-[100px]">
        <div className="mb-8 flex items-end justify-between border-t border-[#0A1633]/10 pt-7">
          ...
          <span className="text-[13px] tabular-nums text-[#0A1633]/40">
            {String(filteredReports.length).padStart(2, "0")} / {String(reports.length).padStart(2, "0")}
          </span>
        </div>

        {filteredReports.length === 0 ? (
          <p className="py-16 text-center text-[14px] text-[#0A1633]/55">

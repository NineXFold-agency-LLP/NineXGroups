...
const cases = [
  { client: "Global Automotive OEM", result: "1M+", label: "vehicles connected", title: "Building a software-defined vehicle platform", img: "https://images.unsplash.com/photo-1617788138017-80ad40651399?q=80&w=1200&auto=format&fit=crop", tag: "Automotive", href: "/industries/automotive-mobility" },
  { client: "Regional Bank · $50B", result: "5 min", label: "account opening, from 2 weeks", title: "A cloud-native digital banking turnaround", img: "https://images.unsplash.com/photo-1563013544-824ae1b704d3?q=80&w=1200&auto=format&fit=crop", tag: "Fintech", href: "/industries/fintech" },
  { client: "$10B Omnichannel Retailer", result: "300%", label: "online revenue growth", title: "Unifying store and digital into one experience", img: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=1200&auto=format&fit=crop", tag: "Retail", href: "/industries/retail-ecommerce" },
  { client: "$5B Aerospace Manufacturer", result: "$80M", label: "annual savings", title: "Predictive maintenance across the line", img: "https://images.unsplash.com/photo-1581092160562-40aa08e78837?q=80&w=1200&auto=format&fit=crop", tag: "Manufacturing", href: "/industries/manufacturing-industry-4" },
  { client: "Series B SaaS", result: "3X", label: "revenue, year-over-year", title: "From monolith to product-led growth", img: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=1200&auto=format&fit=crop", tag: "Technology", href: "/industries/technology-saas" },
  { client: "Blue Tree Health", result: "+", label: "conversion on every funnel", title: "A premium telehealth funnel, rebuilt", img: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?q=80&w=1200&auto=format&fit=crop", tag: "Healthcare", href: "/industries/healthcare" },
];
